...
export const PERSON_ALIASES: Record<string, string> = {
	...
	北原モコットゥナㇱ: 'mokottunas-kitahara', 北原モコットゥナシ: 'mokottunas-kitahara',
...
export const PERSON_ENRICH: Record<string, { nameEn?: string; researchmap?: string; wikidata?: string }> =
	{
		...
		田中吉人: { nameEn: 'Tanaka Yoshihito' }, 大野徹人: { nameEn: 'Ōno Tetsuto' },
		...
		菅原勝吉: { nameEn: 'Sugawara Katsuyoshi' }, 菅原勝良: { nameEn: 'Sugawara Katsuyoshi' },
		...
		大喜多紀明: { nameEn: 'Ōgita Noriaki', researchmap: 'utari' }, オオギタノリアキ: { nameEn: 'Ōgita Noriaki' },
		...
		'佐藤ロスベアグナナ': { nameEn: 'Nana Sato-Rossberg' }, 高橋規: { nameEn: 'Takahashi Tadashi' },
